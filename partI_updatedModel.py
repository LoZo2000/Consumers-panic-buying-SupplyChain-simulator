...
t_run =  150 # 100                           # number of steps (days) in a run
...
satsf_cus = np.zeros([t_run,n_runs])
empty_sto = np.zeros([t_run,n_runs])
TTFR = []
...
for r in range(n_runs):
    ...
    for i in range(t_run):
        ...
        satsf_cus[i][r] = (N-model_1.starving)/N*100
        empty_sto[i][r] = model_1.empty/N_s*100
