...
class ResponsiveGraph():
    ...
    def update(self, r, d, ifr, star):
        ...
        self.ax3.plot(self.t[:r], self.ifr_dc[:r], 'b', marker='o', label='IFR of the DC' if i == 0 else "") #IFR of DC
        self.ax3.plot(self.t[:r], self.starvation[:r], 'r', marker='o', label='% of satisfied customers' if i == 0 else "") #Percentage of people who managed to buy q food
